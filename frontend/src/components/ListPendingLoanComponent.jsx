...
import { deleteLoan,sanctionLoan,listPendingLoans } from "../services/LoanService";
import { useNavigate } from "react-router-dom";

const ListPendingLoanComponent = () => {
    ...
    useEffect(() => {
      ...
      return (
        <div className="table-container">
          <div class="box">
          <h2 className="text-center">List of Pending Loans</h2>
    ...
    export default ListPendingLoanComponent;